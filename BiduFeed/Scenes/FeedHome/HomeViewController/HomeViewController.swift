...
extension HomeViewController {
    func setUpTableView() {
        mainTableView.registerCell(HomeTableViewCell.cellIdentifier)
...
extension HomeViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = mainTableView.dequeueReusableCell(withIdentifier: HomeTableViewCell.cellIdentifier) as! HomeTableViewCell
        cell.configure(with: Infomation.infomation[indexPath.row], image: images)
        return cell
    }
}
